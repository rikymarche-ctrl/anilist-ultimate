/**
 * @file AstraDashboardV2.ts
 * @description Modern, reactive replacement for the monolithic AstraDashboard
 */
...
@injectable()
@singleton()
export class AstraDashboardV2 extends AstraView {
  ...
  protected onMount(): void {
    const content = this.$('#astra-v2-content');
    if (!content) return;

    if (this.activeTab === 'dashboard') {
      content.innerHTML = `
        <div class="astra-dashboard-v2-layout">
